...
@section('content')
    <h2 style="color:#2563eb">Lamaran Terkirim</h2>
    ...
    <div class="info-box info-blue">
        <table style="width:100%;border-collapse:collapse;font-size:13px">
            <tr><td style="padding:2px 0;color:#6b7280">Status</td><td style="padding:2px 0;text-align:right;font-weight:600;color:#2563eb">Dikirim</td></tr>
